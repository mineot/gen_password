...
export const TypeDimension = {
  ...
  [TypeEnum.COMPLEX]: {
    [DimensionEnum.FOUR]: { upp: 1, low: 1, num: 1, chr: 1 },
    [DimensionEnum.SIX]: { upp: 1, low: 2, num: 2, chr: 1 },
    [DimensionEnum.EIGTH]: { upp: 2, low: 2, num: 2, chr: 2 },
    [DimensionEnum.TEN]: { upp: 3, low: 3, num: 2, chr: 2 },
    [DimensionEnum.TWELVE]: { upp: 3, low: 3, num: 3, chr: 3 },
    [DimensionEnum.FOURTEEN]: { upp: 4, low: 4, num: 4, chr: 2 },
    [DimensionEnum.SIXTEEN]: { upp: 4, low: 4, num: 4, chr: 4 },
    [DimensionEnum.EIGHTEEN]: { upp: 5, low: 5, num: 5, chr: 3 },
    [DimensionEnum.TWENTY]: { upp: 5, low: 5, num: 5, chr: 5 },
  },
};
